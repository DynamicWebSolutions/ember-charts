module.exports = function(app) {
  ...
  var bubbleDefaultRouter = express.Router();

  bubbleDefaultRouter.get('/', function(req, res) {
    res.send({
      'bubble/default': [
  {
  ...
  bubbleDefaultRouter.post('/', function(req, res) {
    res.status(201).end();
  });

  bubbleDefaultRouter.get('/:id', function(req, res) {
    res.send({
      'bubble/default': {
        id: req.params.id
      }
  ...
  bubbleDefaultRouter.put('/:id', function(req, res) {
    res.send({
      'bubble/default': {
        id: req.params.id
      }
  ...
  bubbleDefaultRouter.delete('/:id', function(req, res) {
    res.status(204).end();
  });

  app.use('/api/bubble/default', bubbleDefaultRouter);
};
